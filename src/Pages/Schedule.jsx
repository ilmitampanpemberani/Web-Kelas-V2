...
const Schedule = () => {
    ...
    piketGroup = [
        ["Burhan", "Ayubi", "Chelia", "Jasmine", "Nezza", "Fika"],
        ["Angga", "Giri", "Devita", "Fitri", "Putri", "Sofia"],
        ["Alan", "Albi", "Dinda", "Mia", "Risa", "Zaskia"],
        ["Jovan", "Daffa", "Erni", "Nabila", "Salwa", "Sekar"],
        ["Azuan", "Alfiah", "Fida", "Najah", "Sabila"],
        ["Ilham", "Aulia", "Sicha", "Nely", "Sherly"],
    ]
